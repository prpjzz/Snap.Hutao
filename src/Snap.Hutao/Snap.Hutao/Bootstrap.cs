...
public static partial class Bootstrap
{
    ...
    {
        if (new UniversalApiContract.Version("10", "0", "19044", "5371") > UniversalApiContract.WindowsVersion)
        {
            const string Message = """
                Snap Hutao 无法在版本低于 10.0.19044.5371 的 Windows 上运行，请更新系统。
                Snap Hutao cannot run on Windows versions earlier than 10.0.19044.5371. Please update your system.
                """;
